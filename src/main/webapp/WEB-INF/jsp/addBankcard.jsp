	...
	<div class="container">
		<div class="header-top">
			...
			<div id="content">
				...
				<form action="user/addBankcard" method="post"
					...
					<div id="register_box" class="col-md-12">
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-md-3 control-label"
								style="margin-top: 10px; margin-left: 20px;">银行卡号 </label>
							<div class="col-md-8">
								<input type="text" class="form-control" id="inputPassword3"
									placeholder="请输入银行卡号" name="bankCardId"
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-md-3 control-label"
								style="margin-top: 10px; margin-left: 20px;">银行名称 </label>
							<div class="col-md-8">
								<input type="text" class="form-control" id="inputPassword3"
									placeholder="请输入银行名称" name="bankCardName"
									style="margin-top: 5px; margin-left: -12px;">
							</div>
						</div>
