		...
		<div class="header-top">
			...
			<div class="top-nav">
				...
				<ul>
					...
					<li id="one-li"><a href="shipping.html"> 我的OIO </a></li>
			...
			<div id="content" style="width:600px; height:450px; text-align:center">
					
				<form action="user/add" method="post" enctype="multipart/form-data">
					<div id="modifyuser_box" class="col-md-6">
						<div>
							<p id="login_p">${msg}</p>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="password" class="form-control" id="inputPassword3"
									placeholder="请输入修改密码" name="password"
						...
						<div>
							<button class="col-md-9 btn btn-default"
								style="margin-top: 15px; margin-left: 50px; font-weight: bold;">修&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp改</button>
						</div>
