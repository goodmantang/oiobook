			...
			<div id="content">
				...
				<form action="user/forgetPwd" method="post"
					...
					<div id="register_box" class="col-md-12">
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<input type="text" class="form-control" id="inputEmail3"
									placeholder="请输入用户" name="userName"
						...
						<!-- <div class="form-group ">
							<label for="inputEmail3" class="col-md-3 control-label"
								style="margin-top: 30px; margin-left: 20px;">选择方式:</label>
							<select class="form-control col-md-2">
						<option value="0">手机号</option>
						<option value="1">邮箱</option>
						</select>
							<label class="radio-inline"> <input type="radio"
								name="operate" value="0" checked="true">手机
							</label> <label class="radio-inline"> <input type="radio"
								name="operate" value="1">邮箱
							</label>
						</div> -->
						
						<div class="form-group">
						    <label class="col-sm-3 control-label" style="margin-left: 5.5%">方式：</label>
						    <div class="col-sm-5" style="padding-left: 0px;padding-right: 40px;">
						      <label class="radio-inline"> <input type="radio"
								name="operate" value="0" checked="true">手机
							</label> <label class="radio-inline"> <input type="radio"
								name="operate" value="1">邮箱
						...
						<div class="form-group">
							<label for="inputPassword3" class="col-md-3 control-label"
								style="margin-top: 10px; margin-left: 20px;">邮编/手机号</label>
							<div class="col-md-8">
						...
						<div>
							<button class="col-md-9 btn btn-default"
								style="margin-top: 15px; margin-left: 50px; font-weight: bold;">提&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp交</button>
						</div>
